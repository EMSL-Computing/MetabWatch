...
- **Custom JSON** — browse to a pipeline config file (same schema as `metabwatch --config`), or use **Write starter folder** to create one plus editable copies of the RP method files (CoreMS TOML, and QC CSV when targeted)
