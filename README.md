...
- **Custom JSON** — browse to a pipeline config file (same schema as `metabwatch --config`), or use **Create custom config** to make one plus editable copies of the RP method files (CoreMS TOML, and `monitored_compounds.csv` when targeted)
