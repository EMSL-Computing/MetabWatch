...
- **Preset shortcuts** — LC Method dropdown (packaged HILIC / RP methods) × targeted or untargeted, optional polarity and project ID, plus input/output folder pickers
